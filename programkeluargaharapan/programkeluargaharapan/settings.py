"""
Django settings for programkeluargaharapan project.
...
PREDICTORS_DIR = os.path.join(SCRIPTS_DIR, 'predictors')
...
ROOT_URLCONF = 'programkeluargaharapan.urls'
...
WSGI_APPLICATION = 'programkeluargaharapan.wsgi.application'
